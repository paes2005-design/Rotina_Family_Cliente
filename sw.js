const CACHE_NAME='rotina-family-cliente-v38';
const APP_SHELL=['./','./index.html','./index-CLIENTE-v6.html','./manifest.json?v=25','./icon-cliente-192.png','./icon-cliente-512.png','./app-monitoring.js','./client-ui-pro.css','./client-ui-pro.js','./client-week-nav.js','./family-alarm-client.js','./alarm-schedule-core.js','./client-time-guard-v2.js','./client-history-reconciler.js','./scoring-core.js','./client-reviewed-points.js','./client-early-start-ui.js','./client-tolerance-timer.js','./tolerance-timer-core.js','./reset-cache.html'];
