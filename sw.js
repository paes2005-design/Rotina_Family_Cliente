const CACHE_NAME='rotina-family-cliente-v21';
const APP_SHELL=['./','./index.html','./index-CLIENTE-v6.html','./manifest.json','./icon-cliente-192.png','./icon-cliente-512.png','./client-ui-pro.css','./client-ui-pro.js','./client-time-guard-v2.js','./scoring-core.js','./client-reviewed-points.js','./client-early-start-ui.js','./reset-cache.html'];
