...
import {deveDispararAgora,descreverProximaOcorrencia} from './alarm-schedule-core.js?v=1';
...
function estaNaHora(a,agora){return !tarefaConcluida(a?.tarefaId)&&deveDispararAgora(a,agora)}
