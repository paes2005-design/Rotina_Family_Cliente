(()=>{
  ...
  const MODULES=Object.freeze([
    ...
    {name:'task-alarm',src:'./family-alarm-client.js?v=12',type:'module',owner:'Alarm',critical:false},
    ...
    {name:'runtime-build-info',src:'./runtime-build-info.js?v=20260908.1',type:'classic',owner:'Runtime/Version',critical:false}
  ]);
