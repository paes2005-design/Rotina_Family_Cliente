(()=>{
  'use strict';
  const INFO=Object.freeze({app:'PARTICIPANTE',appVersion:'1.0.0',build:'20260915.5',htmlVersion:'index-CLIENTE-v6',rulesModuleVersion:'4',expectedServiceWorkerVersion:'91',initialSyncCompatVersion:'1',bootstrapVersion:'1',participantStoreVersion:'2',firebaseRepositoryVersion:'3',syncSchedulerVersion:'3',earlyStartUiVersion:'3',toleranceTimerUiVersion:'6',historyGapReconcilerVersion:'2',alarmRuntimeVersion:'16',participantPushRuntimeVersion:'2'});
